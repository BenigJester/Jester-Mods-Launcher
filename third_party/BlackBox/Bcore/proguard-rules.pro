...
# BlackReflection resolves every hidden-API proxy from runtime annotations. R8 can
# keep the annotated interfaces while still removing their annotation attributes,
# which makes every proxy fail with "Not found @BlackClass or @BlackStrClass".
