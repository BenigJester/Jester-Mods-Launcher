...
# BlackReflection inspects these annotations after the Bcore AAR is merged into
# the minified launcher. Preserve the metadata during the app-level R8 pass too.
