...
public class IAccountManagerProxy extends BinderInvocationStub {
    ...
    private static String virtualPackageName() {
        String packageName = BActivityThread.getAppPackageName();
        return packageName == null ? BlackBoxCore.getHostPkg() : packageName;
    }

    private static int virtualUid() {
        int uid = BActivityThread.getBUid();
        return uid > 0 ? uid : BlackBoxCore.getHostUid();
    }

    private static Bundle normalizeAuthenticatorOptions(Bundle options) {
        Bundle normalized = options == null ? new Bundle() : options;
        normalized.putString(AccountManager.KEY_ANDROID_PACKAGE_NAME, virtualPackageName());
        normalized.putInt(AccountManager.KEY_CALLER_UID, virtualUid());
        Slog.i("GoogleSignInCompat", "Account request caller=" + virtualPackageName()
                + " buid=" + virtualUid());
        return normalized;
    }
    ...
    public static class getAccountsForPackage extends MethodHook {
        ...
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return BAccountManager.get().getAccountsForPackage(virtualPackageName(), virtualUid());
        }
    }
    ...
    public static class getAccountsByTypeForPackage extends MethodHook {
        ...
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            return BAccountManager.get().getAccountsByTypeForPackage((String) args[0], virtualPackageName());
        }
    }
    ...
    public static class getAuthToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            BAccountManager.get().getAuthToken((IAccountManagerResponse) args[0],
                    ...
                    (boolean) args[3],
                    (boolean) args[4],
                    normalizeAuthenticatorOptions((Bundle) args[5]));
            return 0;
        }
    }
    ...
    public static class updateCredentials extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            BAccountManager.get().updateCredentials((IAccountManagerResponse) args[0],
                    ...
                    (String) args[2],
                    (boolean) args[3],
                    normalizeAuthenticatorOptions((Bundle) args[4]));
            return 0;
        }
    }
    ...
    public static class confirmCredentialsAsUser extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            BAccountManager.get().confirmCredentialsAsUser((IAccountManagerResponse) args[0],
                    (Account) args[1],
                    normalizeAuthenticatorOptions((Bundle) args[2]),
                    (boolean) args[3]);
            return 0;
        }
    }
