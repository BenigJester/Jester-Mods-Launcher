...
internal object LauncherLocalization {
    ...
    private val TRANSLATIONS = mapOf(
        ...
        "Help" to row("Tulong", "도움말", "ヘルプ", "帮助", "Ayuda", "Trợ giúp", "Bantuan"),
        ...
        "HELP & SUPPORT" to row("TULONG AT SUPORTA", "도움말 및 지원", "ヘルプとサポート", "帮助与支持", "AYUDA Y SOPORTE", "TRỢ GIÚP & HỖ TRỢ", "BANTUAN & DUKUNGAN"),
        "Find guidance and report issues through the official public repository." to row("Humanap ng gabay at mag-ulat ng problema sa opisyal na pampublikong repository.", "공식 공개 저장소에서 안내를 확인하고 문제를 신고하세요.", "公式公開リポジトリでガイドを確認し、問題を報告できます。", "通过官方公共仓库查找指南并报告问题。", "Consulta la guía e informa de problemas mediante el repositorio público oficial.", "Tìm hướng dẫn và báo cáo sự cố qua kho lưu trữ công khai chính thức.", "Temukan panduan dan laporkan masalah melalui repositori publik resmi."),
        "JESTER MODS SUPPORT" to row("SUPORTA NG JESTER MODS", "JESTER MODS 지원", "JESTER MODS サポート", "JESTER MODS 支持", "SOPORTE DE JESTER MODS", "HỖ TRỢ JESTER MODS", "DUKUNGAN JESTER MODS"),
        "Help & Support" to row("Tulong at Suporta", "도움말 및 지원", "ヘルプとサポート", "帮助与支持", "Ayuda y soporte", "Trợ giúp & Hỗ trợ", "Bantuan & Dukungan"),
        ...
        "BEFORE YOU REPORT" to row("BAGO MAG-ULAT", "신고하기 전에", "報告する前に", "报告之前", "ANTES DE INFORMAR", "TRƯỚC KHI BÁO CÁO", "SEBELUM MELAPOR"),
        "Update first" to row("Mag-update muna", "먼저 업데이트", "まず更新", "先更新", "Actualiza primero", "Cập nhật trước", "Perbarui dahulu"),
        ...
        "Capture the details" to row("Itala ang mga detalye", "세부 정보 기록", "詳細を記録", "记录详情", "Anota los detalles", "Ghi lại chi tiết", "Catat detailnya"),
        "Include your launcher edition, game version, build number, and the steps that caused the issue." to row("Isama ang launcher edition, game version, build number, at mga hakbang na nagdulot ng problema.", "런처 에디션, 게임 버전, 빌드 번호와 문제가 발생한 단계를 포함하세요.", "ランチャーのエディション、ゲームバージョン、ビルド番号、問題が起きた手順を含めてください。", "请包含启动器版本、游戏版本、构建号以及导致问题的操作步骤。", "Incluye la edición del lanzador, la versión y compilación del juego y los pasos que causaron el problema.", "Hãy nêu phiên bản trình khởi chạy, phiên bản và số bản dựng trò chơi cùng các bước gây ra sự cố.", "Sertakan edisi peluncur, versi dan nomor build game, serta langkah yang memicu masalah."),
        "Protect your privacy" to row("Protektahan ang iyong privacy", "개인정보 보호", "プライバシーを保護", "保护隐私", "Protege tu privacidad", "Bảo vệ quyền riêng tư", "Lindungi privasi Anda"),
        "Never post access codes, recovery details, or other personal information." to row("Huwag mag-post ng access code, recovery detail, o iba pang personal na impormasyon.", "액세스 코드, 복구 정보 또는 기타 개인정보를 게시하지 마세요.", "アクセスコード、復旧情報、その他の個人情報は投稿しないでください。", "切勿发布访问代码、恢复详情或其他个人信息。", "Nunca publiques códigos de acceso, datos de recuperación ni otra información personal.", "Không đăng mã truy cập, thông tin khôi phục hoặc dữ liệu cá nhân khác.", "Jangan pernah memposting kode akses, detail pemulihan, atau informasi pribadi lainnya."),
        "OFFICIAL SUPPORT" to row("OPISYAL NA SUPORTA", "공식 지원", "公式サポート", "官方支持", "SOPORTE OFICIAL", "HỖ TRỢ CHÍNH THỨC", "DUKUNGAN RESMI"),
        "Report an issue" to row("Mag-ulat ng problema", "문제 신고", "問題を報告", "报告问题", "Informar de un problema", "Báo cáo sự cố", "Laporkan masalah"),
        "Open the public issue page to report a bug, request help, or suggest an improvement." to row("Buksan ang pampublikong issue page para mag-ulat ng bug, humingi ng tulong, o magmungkahi ng improvement.", "공개 이슈 페이지에서 버그를 신고하거나 도움을 요청하고 개선 사항을 제안하세요.", "公開 Issue ページでバグの報告、サポートの依頼、改善案の提案ができます。", "打开公共问题页面以报告错误、请求帮助或提出改进建议。", "Abre la página pública de incidencias para informar de un error, pedir ayuda o sugerir una mejora.", "Mở trang sự cố công khai để báo lỗi, yêu cầu trợ giúp hoặc đề xuất cải tiến.", "Buka halaman masalah publik untuk melaporkan bug, meminta bantuan, atau menyarankan peningkatan."),
        "Open issue page" to row("Buksan ang issue page", "이슈 페이지 열기", "Issue ページを開く", "打开问题页面", "Abrir página de incidencias", "Mở trang sự cố", "Buka halaman masalah"),
