    ...
    private val entries = buildMap {
        ...
        put(
            ...
            arrayOf(
                ...
                "إضافة خاصة، يتم التحقق من الموافقة قبل الاستخدام"
            )
        )
        put(
            "Unselect {0}",
            arrayOf(
                ...
                "Anular selecci\u00F3n de {0}", "B\u1ECF ch\u1ECDn {0}", "Batal pilih {0}", "Desmarcar {0}", "إلغاء تحديد {0}"
            )
        )
        put(
            "Select {0}",
            arrayOf(
                ...
                "Seleccionar {0}", "Ch\u1ECDn {0}", "Pilih {0}", "Selecionar {0}", "تحديد {0}"
            )
        )
